<template>
  <div>
    <div :class="['mrecorder', {anirecorder: recording } ] ">
      <i
        :class="(recording==true)?'el-icon-microphone':'el-icon-turn-off-microphone'   "
        @click="handleClick"
      />
      <p class="tip fs-xs" style="width:300px">{{ tiptext }}</p>
    </div>
...
export default {
  ...
  methods: {
    ...
    // 错误处理方法
    onMediaError(e) {
      global.console.log("啊咧咧~您的浏览器貌似不支持录音哦...", e);
